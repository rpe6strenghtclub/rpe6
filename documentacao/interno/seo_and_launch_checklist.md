...
O site já está lançado em `https://rpe6.com.br`, no GitHub Pages. Publicação inicial e domínio não são pendências. A atualização local de 2026-09-22 foi validada localmente e ainda requer deploy separado.
...
- [x] Independência entre Academy e Club e oferta de planos a partir de R$ 39,19 ao mês no parcelamento anual preservadas.
...
- [x] Seletor de planos acessível, com foco, Escape, clique fora, fallback sem JavaScript e checkouts em nova aba; anual com brilho visual contínuo, inclusive com redução de movimento.
