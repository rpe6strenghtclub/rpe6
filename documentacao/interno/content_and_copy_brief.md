...
Estado em 2026-09-05: site lançado em rpe6.com.br, em manutenção no GitHub Pages. A refatoração local preservou integralmente a copy e a oferta; seu deploy é separado.

## Objetivo

Apresentar a RPE6 Strength Academy como plataforma educacional em vídeo para aperfeiçoamento em powerlifting e treinamento de força, com linguagem direta, técnica e profissional, sem prometer resultados individuais. A RPE6 Strength é a marca do treinador; o RPE6 Strength Club é sua equipe de competição e não faz parte do acesso à Academy.
...
- O botão flutuante oferece contato pelo WhatsApp.
- O rodapé publica CREF `189456-G/SP`, telefone `(12) 98152-1537` e o link visível “linkTree”.
- A oferta apresentada é exclusivamente a RPE6 Strength Academy.

## Limites editoriais

- Falar de técnica, planejamento e educação sem assegurar performance, recordes, emagrecimento ou reabilitação.
...
- Biografia ampliada e demais credenciais verificáveis do treinador.
- Lista final de aulas, módulos e materiais.
- Políticas de suporte, reembolso, privacidade e termos.

Toda alteração de texto público deve ser aprovada pelo responsável da RPE6.
